<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultaEstoquePreACD_New2.aspx.cs" Inherits="Sistema.DUE.Web.ConsultaEstoquePreACD_New2" %>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="row no-gutter">                        
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label">CNPJ Destinatário:</label> &nbsp; <small>(Informe 1 ou mais CNPJ's separados por vírgula. Ex: 00.000.000/0000-00, 11.111.111/1111-11)</small>

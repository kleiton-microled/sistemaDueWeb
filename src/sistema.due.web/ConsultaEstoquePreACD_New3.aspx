<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultaEstoquePreACD_New3.aspx.cs" Inherits="Cargill.DUE.Web.ConsultaEstoquePreACD_New3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script>
        ...
        function Consultar() {
            ...
            console.log('pagina while: ' + pagina);
            console.log('total pagina while: ' + totalPaginas);
            console.log('while: ' + (pagina <= totalPaginas));

            for (var pagina = 1; pagina <= totalPaginas; pagina++) {
                GerarCSV(guid, pagina, registrosPorPagina, filtro, totalPaginas);
            }
        }

        function GerarCSV(guid, pagina, registrosPorPagina, filtro, totalPaginas) {
            ...
            var postData = { guid: guid, pagina: pagina, registrosPorPagina: registrosPorPagina, filtro: JSON.stringify(filtro) };

            $.ajax({
                type: "POST",
                url: "ConsultaEstoquePreACD_New3.aspx/ConsultarEstoquePreACD",
                ...
                success: function () {
                    ...
                    var valorPerc = (paginasProcessadas / (totalPaginas / 100)).toFixed(2);
                    var perc = valorPerc + '%';
                    console.log(perc + '%');
                    ...
                    paginasProcessadas = paginasProcessadas + 1;
